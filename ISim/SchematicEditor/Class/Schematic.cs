...
using ISim.SchematicEditor.Interface;
...
*      
*/
        public void ShowAll(Point lowerRange, Point higherRange, Canvas surface, int zoom)
        {
            foreach (var component in components)
            {
                ...
                {
                    component.item.Visible = true;
                    component.item.zoom = zoom;
                    component.OnShow(surface);
                }
                else
                {
                    component.item.Visible = false;
                }
            }
