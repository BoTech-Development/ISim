...
internal static class StorageService
{
    ...
    public static FilePickerFileType ISimSln { get; } = new FilePickerFileType("ISimSln")
    {
        Patterns = new[] { "*.ISimSln" },
        AppleUniformTypeIdentifiers = new[] { "public.ISimSln" },
        MimeTypes = new[] { "application/ISimSln" }
    };
